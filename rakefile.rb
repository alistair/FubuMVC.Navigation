...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Navigation"
COPYRIGHT = 'Copyright 2012 FubuMVC.Navigation. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Navigation.sln', :clrversion => CLR_TOOLS_VERSION
